...
def tof_to_initial_wavelength_igs_lin_time_zero(obj, **kwargs):
    ...
    to initial_wavelength_igs_lin_time_zero. The time-of-flight axis for a SOM
    must be in units of microseconds. The primary axis of a SO is assumed to
    be in units of microseconds. A tuple of [tof, tof_err2] (assumed to be in
    units of microseconds) can be converted to [initial_wavelength,
