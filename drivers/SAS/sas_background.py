...
if __name__ == "__main__":
    ...
    parser.remove_option("--data-acc-down-time")
    parser.remove_option("--solv-acc-down-time")
    parser.remove_option("--ecan-acc-down-time")
    parser.remove_option("--open-acc-down-time")
