...
will repeat steps 1-2,4-9,17,24-27,30-33
"""
...
def run(config, tim):
    ...
    # Step 26-27: Subtract background spectrum from normalization spectrum
    ...
    # Step 30-31: Subtract empty can spectrum from normalization spectrum
